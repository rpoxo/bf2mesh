...
test_object_tris = os.path.join(*['objects', 'staticobjects', 'test', 'evil_box8', 'meshes', 'evil_box8.staticmesh'])
test_object_poly = os.path.join(*['objects', 'staticobjects', 'test', 'evil_box9', 'meshes', 'evil_box9.staticmesh'])
test_object_poly_merged = os.path.join(*['objects', 'staticobjects', 'test', 'evil_box_2xplane', 'meshes', 'evil_box_2xplane.staticmesh'])
...
for index, vertex in enumerate(vmesh.vertices_attributes):
    print('merged[{}] {} {}'.format(index, vertex['position'], vertex['normal']))
